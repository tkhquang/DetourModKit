...
- `Lifecycle.DestroyLockFailureRetainsRoute` uses that host to inject a recursive-mutex failure. Published and unpublished routes retain their executable storage and charge exactly once.
