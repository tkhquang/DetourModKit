...
include/DetourModKit/    # Public headers -- one per module
  ...
  anchor.hpp             # Declarative anchor registry (namespace DetourModKit::anchor): AnchorKind (VtableIdentity / RipGlobal / CodeOperand / StringXref / Manual / CallArgHome / Quorum), QuorumMatch (ExactValue / WithinTolerance), AnchorStatus (Unresolved / Resolved / Failed / Unsupported / QuorumNotIndependent); flat designated-init Anchor aggregate (site = span<const scan::Candidate>, scope = Region, optional AnchorValidator); ResolvedAnchor {label, kind, status, value}; AnchorQuality; ScanProfile (default_broad_string_xref, candidate_order = scan::CandidateOrder, deny_backend, is_denied); free functions resolve / resolve_all / resolve_all_parallel / assess_quality / anchor_fingerprint / apply_profile / resolve_with_profile / resolve_all_with_profile / resolve_all_with_profile_parallel. anchor_fingerprint hashes the COMPILED Pattern content (bytes + wildcard mask + decode params), not AOB source text. Quorum corroboration performs sub-anchor independence checks. Candidate ordering reuses scan::CandidateOrder / scan::order_candidates
